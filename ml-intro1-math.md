...
![](https://i.loli.net/2020/09/02/2VMxbcDkFCmasPn.png)
...
**梯度下降法\(gradient descent method\)**是一个一阶最优化算法，其基本思想是，每次迭代用当前位置的负梯度方向作为搜索方向。因为对于可微函数$$f(\pmb x)$$，函数值下降最快的方向就是负梯度方向。
...
![](https://upload.wikimedia.org/wikipedia/commons/thumb/6/60/Banana-SteepDesc.gif/400px-Banana-SteepDesc.gif)
...
![](https://i.loli.net/2020/10/15/51GPfgUSVjkL98e.png)
