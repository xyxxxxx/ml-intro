...
1. C1 层是卷积层，使用 6 个 5×5 的卷积核，得到 6 组大小为 28×28 = 784的特征映射。
2. S2 层为汇聚层，采样窗口为 2 × 2 ，使用平均汇聚，并使用一个非线性函数。
...
4. S4 层是一个汇聚层，采样窗口为 2 × 2，得到 16 个 5 × 5 大小的特征映射。
5. C5 层是一个卷积层，使用 120 × 16 = 1920 个 5 × 5 的卷积核，得到120 组大小为 1 × 1 的特征映射。
6. F6 层是一个全连接层，有 84 个神经元。
